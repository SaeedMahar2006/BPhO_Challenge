...
namespace Test
{
    public static class Program
    {
        static void Main(string[] args)
        {
            ...
            Vector enutoeceftest = new Vector(3);

            //enutoeceftest[0] = 355;
            //enutoeceftest[1] = -923;
            //enutoeceftest[2] = 1041;

            enutoeceftest[0] = -27.6190;
            enutoeceftest[1] = -16.4298;
            enutoeceftest[2] = -0.3186;


            enutoeceftest *= kmhtoms;

            var res = SimpleFormulae.ENUToECEF_Velocity(enutoeceftest, c1,0);
            ...
            //foreach (var i in SimpleFormulae.EarthSpinProjectile(c1, 149.04, 45, 8000, 100, 0.000000, 1, 1))
            //{
            //    Console.WriteLine(i);
            //}
